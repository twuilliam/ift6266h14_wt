...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, output_folder='output'):
    """
   ...
   """
    ...
    while (epoch < n_epochs) and (done_looping == False):
        epoch = epoch + 1
    ...
    with open(os.path.join(output_folder, 'results.txt'), 'w+') as f:
        f.write(('Optimization complete. Best validation score of %f '
...
if __name__ == '__main__':
    ...
    test_mlp(batch_size=20, n_epochs=2000, n_hidden=1000, dataset='../timit_oy_train_aug.npz', output_folder='noisy_oy')
